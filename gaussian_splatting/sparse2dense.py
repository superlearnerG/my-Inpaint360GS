...
def pipeline(scene, base_path, n_views):
    ...
    os.system('colmap image_undistorter --image_path images --input_path triangulated --output_path dense --output_type COLMAP')
...
for scene in ['test_test']:
    pipeline(scene, base_path = '/home/swang/Documents/project/gaussian_splatting/data/our/car/', n_views = 24)  # please use absolute path!
