...
def create_point_cloud(depth_map, intrinsic_matrix, extrinsic_matrix):
    """
    Based on depth_map, intrinsic_matrix, extrinsic_matrix to create a point cloud
    """
    ...
    # Transform points from camera coordinate to World
...
def ply_color_fusion(points, colors, ply_path, mask=None):
    ...
    color: (H*W， 3)
    ply_path: 
    mask: (H*W， ) only target area saved
